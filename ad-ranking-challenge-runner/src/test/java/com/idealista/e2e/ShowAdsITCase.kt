    ...
    fun `Given an ad list with the score calculated when the ads are shown then all relevant ads are returned`() {
        ...
        assertThat(responseEntity.body)
                ...
                .isEqualTo(listOf(
                        ...
                        mapOf("id" to 6, "typology" to Typology.GARAGE.name, "description" to "", "pictureUrls" to listOf("http://www.idealista.com/pictures/6"), "houseSize" to 300, "gardenSize" to null)
                ))
    }
